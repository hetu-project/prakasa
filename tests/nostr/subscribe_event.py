...
from prakasa_nostr.events import CHAT_KIND, DINF_TASK_PUBLISH_KIND, DINF_EVALUATION_KIND, DINF_TASK_ASSIGN_KIND, DINF_TASK_RESULT_KIND, DINF_WORKLOAD_PROOF_KIND, DINF_SETTLEMENT_KIND

listen_kinds_list = [CHAT_KIND, DINF_TASK_PUBLISH_KIND, DINF_TASK_ASSIGN_KIND, DINF_TASK_RESULT_KIND, DINF_WORKLOAD_PROOF_KIND, DINF_SETTLEMENT_KIND, DINF_EVALUATION_KIND]
